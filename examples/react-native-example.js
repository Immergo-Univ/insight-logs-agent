/**
 * React Native Example - Explicit Platform Selection
 * 
...
// Explicitly import the React Native implementation
...
const ExampleScreen = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.subtitle}>Platform: {insightLogger._platform}</Text>
      <Text style={styles.subtitle}>Version: {insightLogger._version}</Text>
